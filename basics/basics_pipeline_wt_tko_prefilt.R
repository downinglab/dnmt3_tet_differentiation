...
# Define file paths
# This is the directory of the filtered, but not normalized or downsampled
# transcript counts generated by the preprocessing step
base_path <- "../preprocessing/transcript_counts/wt_tko/filtered"
